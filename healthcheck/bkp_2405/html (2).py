...
<div class="vista" id="vista-perfindex">
  ...
  <section class="block">
    ...
    <p class="sdesc">
      <strong>26 índices em 6 subgrupos</strong>, organizados por dimensão de saúde operacional — alinhados ao padrão SFE da indústria farmacêutica.
    ...
    <div style="display:grid;grid-template-columns:repeat(6,1fr);gap:8px;margin-bottom:14px;">
      <div style="background:#F4F8FB;border-top:3px solid #5566A8;padding:8px 10px;border-radius:4px;">
        ...
        <div style="font-size:10px;color:var(--ink2);margin-top:4px;">ICA · IPA · ICO · IPO · IFP · ICG</div>
      </div>
      <div style="background:#FFF8EE;border-top:3px solid #D4900A;padding:8px 10px;border-radius:4px;">
        ...
        <div style="font-size:10px;color:var(--ink2);margin-top:4px;">ITU · IPV · IAP · IDC</div>
      </div>
      <div style="background:#F0FAF8;border-top:3px solid #1f9d55;padding:8px 10px;border-radius:4px;">
        ...
        <div style="font-size:10px;color:var(--ink2);margin-top:4px;">ICV · IAS · IES · ITV</div>
      </div>
      <div style="background:#FFF1F6;border-top:3px solid #B91C7A;padding:8px 10px;border-radius:4px;">
        ...
        <div style="font-size:10px;color:var(--ink2);margin-top:4px;">IRM · IMP · IDF · IQP</div>
      </div>
    ...
    <p class="sdesc" style="font-size:10.5px;color:var(--ink3);margin-top:-6px;margin-bottom:10px;">
      <strong>Índices marcados ◷</strong> respondem ao filtro de janela (10 dos 25). Os <strong>15 estruturais</strong> refletem ciclo MCCP, snapshot anual ou série fixa — não mudam por janela, por design.
    </p>
    ...
    <!-- Container que recebe o render dos 25 índices -->
...
<div class="vista" id="vista-gloss">
  <section class="block">
    ...
    <div style="margin-bottom:24px;">
      <h3 style="font-size:14px;font-weight:700;color:var(--navy);margin-bottom:14px;padding-bottom:6px;border-bottom:2px solid var(--line);">📊 Índices de Performance — Como Ler Cada Indicador (25 índices em 6 subgrupos)</h3>
      <p style="font-size:11px;color:var(--ink3);margin-top:-8px;margin-bottom:12px;line-height:1.5;">
        <strong>1 · Cobertura &amp; Alcance</strong> (ICA, IPA, ICO, IPO, IFP) · <strong>2 · Capacidade &amp; Produtividade</strong> (ITU, IPV, IAP, IDC) · <strong>3 · Cadência &amp; Consistência</strong> (ICV, IAS, IES, ITV) · <strong>4 · Qualidade de Relacionamento</strong> (IRM, IMP, IDF, IQP) · <strong>5 · Estrutura &amp; Risco de Território</strong> (IET, IRE, IPT, IRO, IUF) · <strong>6 · Alocação de Tempo &amp; Ausências</strong> (IBT, IAA, IAC).<br>
        Indicadores marcados <strong style="color:var(--purple);">◷</strong> respondem ao filtro de janela (10 dos 25). Os <strong>15 estruturais</strong> refletem ciclo MCCP, snapshot anual, série fixa ou cálculo cumulativo — não mudam por janela, por design.
      </p>
      <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:16px;">

        <div class="gloss-card" style="border-top:3px solid #00857C;">
          <h3>ICA — Cobertura de Alvo</h3>
          <div class="gloss-item"><div class="gloss-term">🔎 Pergunta de saúde da operação</div><div class="gloss-def"><em>"O time está visitando os médicos certos — aqueles que a estratégia priorizou?"</em></div></div>
          <div class="gloss-item"><div class="gloss-term">📐 Fórmula</div><div class="gloss-def">% de visitas dentro do painel MCCP oficial do ciclo. (Com Tier A/B: (% Tier A + % Tier B)/2.)</div></div>
          <div class="gloss-item" style="background:#F0FAF8;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#00857C;">✅ Como Interpretar</div><div class="gloss-def">≥ 80% = saudável · 60–79% = atenção · &lt; 60% = crítico. ICA baixo = consultor visitando fora do plano. Cruzar com ICV: foco sem consistência não sustenta relacionamento.</div></div>
          <div class="gloss-item" style="background:#FFF8E7;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#D4900A;">⚠️ Importante Lembrar</div><div class="gloss-def">ICA alto não garante resultado — qualidade da visita importa. Um MCCP desatualizado pode inflar o ICA artificialmente.</div></div>
        </div>

        <div class="gloss-card" style="border-top:3px solid #6B3FA0;">
          <h3>ICV — Consistência de Visitação</h3>
          <div class="gloss-item"><div class="gloss-term">🔎 Pergunta de saúde da operação</div><div class="gloss-def"><em>"O time visita de forma constante ao longo do mês ou concentra tudo na virada do ciclo?"</em></div></div>
          <div class="gloss-item"><div class="gloss-term">📐 Fórmula</div><div class="gloss-def">1 − (desvio padrão ÷ média) das visitas mensais. Escala 0 a 1.</div></div>
          <div class="gloss-item" style="background:#F0FAF8;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#00857C;">✅ Como Interpretar</div><div class="gloss-def">≥ 0,80 = saudável · 0,60–0,79 = atenção · &lt; 0,60 = crítico. Baixo ICV = relação médico-consultor fragilizada pela irregularidade.</div></div>
          <div class="gloss-item" style="background:#FFF8E7;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#D4900A;">⚠️ Importante Lembrar</div><div class="gloss-def">Férias e licenças derrubam o ICV naturalmente. Cruzar com % Ausência antes de concluir sobre o consultor.</div></div>
        </div>
        ...
        <div class="gloss-card" style="border-top:3px solid #2979A0;">
          <h3>IPA — Penetração do Painel</h3>
          <div class="gloss-item"><div class="gloss-term">🔎 Pergunta de saúde da operação</div><div class="gloss-def"><em>"Ao longo do ano, quantos médicos do painel foram tocados ao menos uma vez?"</em></div></div>
          <div class="gloss-item"><div class="gloss-term">📐 Fórmula</div><div class="gloss-def">Médicos únicos MAT 12m ÷ painel oficial × 100.</div></div>
          <div class="gloss-item" style="background:#F0FAF8;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#00857C;">✅ Como Interpretar</div><div class="gloss-def">≥ 80% = excelente · 60–79% = bom · &lt; 60% = crítico. IPA baixo com ICO normal = consultor revisita sempre os mesmos médicos, ignorando parte do painel.</div></div>
          <div class="gloss-item" style="background:#FFF8E7;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#D4900A;">⚠️ Importante Lembrar</div><div class="gloss-def">Painéis grandes têm IPA naturalmente menor. Compare dentro do mesmo perfil de deslocamento para ser justo.</div></div>
        </div>
        ...
        <div class="gloss-card" style="border-top:3px solid #437a22;">
          ...
          <div class="gloss-item"><div class="gloss-term">📐 Fórmula</div><div class="gloss-def">Médicos únicos visitados/mês (média MAT) ÷ painel × 100. Equivale à coluna "Cob. mensal" da tabela Detalhe.</div></div>
          <div class="gloss-item" style="background:#F0FAF8;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#00857C;">✅ Como Interpretar</div><div class="gloss-def">≥ 80% = saudável · 60–79% = atenção · &lt; 60% = crítico. ICO baixo = painel grande demais para a rotina, ou cadência mensal lenta. Use o Simulador para dimensionar o painel ideal.</div></div>
          <div class="gloss-item" style="background:#FFF8E7;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#D4900A;">⚠️ Importante Lembrar</div><div class="gloss-def">Com freq. alvo bimestral (0.5×/mês), ICO = 50% já é o teto esperado — não é crítico neste cenário.</div></div>
        </div>
        ...
        <div class="gloss-card" style="border-top:3px solid #D4900A;">
          ...
          <div class="gloss-item"><div class="gloss-term">📐 Fórmula</div><div class="gloss-def">Visitas realizadas MAT ÷ capacidade anual teórica (dias campo × vis/dia do perfil no Simulador) × 100.</div></div>
          <div class="gloss-item" style="background:#F0FAF8;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#00857C;">✅ Como Interpretar</div><div class="gloss-def">≥ 80% = saudável · 60–79% = atenção · &lt; 60% = crítico. ITU baixo com ausência baixa = produtividade por visita aquém do esperado.</div></div>
          <div class="gloss-item" style="background:#FFF8E7;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#D4900A;">⚠️ Importante Lembrar</div><div class="gloss-def">Depende dos parâmetros do Simulador. Calibre os perfis antes de usar o ITU como referência de cobrança.</div></div>
        </div>
        ...
        <div class="gloss-card" style="border-top:3px solid #006494;">
          ...
          <div class="gloss-item"><div class="gloss-term">📐 Fórmula</div><div class="gloss-def">Visitas realizadas no MCCP do trimestre ÷ meta trimestral do MCCP × 100.</div></div>
          <div class="gloss-item" style="background:#F0FAF8;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#00857C;">✅ Como Interpretar</div><div class="gloss-def">≥ 80% = saudável · 60–79% = atenção · &lt; 60% = crítico. IAS alto + ICA baixo = plano desatualizado em relação à prioridade estratégica real.</div></div>
        ...
        <!-- ── 5 novos índices de Produtividade & Eficiência (Onda v5) ── -->
        <div class="gloss-card" style="border-top:3px solid #1f9d55;">
          <h3>IPV — Produtividade em Visitas <span style="font-size:10px;font-weight:500;color:var(--purple);">◷ janela</span></h3>
          <div class="gloss-item"><div class="gloss-term">🔎 Pergunta de saúde da operação</div><div class="gloss-def"><em>"O consultor está atingindo a meta diária de visitas que sustenta a operação?"</em></div></div>
          <div class="gloss-item"><div class="gloss-term">📐 Fórmula</div><div class="gloss-def">(Vis/dia na janela ÷ meta vis/dia) × 100. Meta default = 6 vis/dia (parametrizável no payload).</div></div>
          <div class="gloss-item" style="background:#F0FAF8;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#00857C;">✅ Como Interpretar</div><div class="gloss-def">≥ 80% = saudável · 60–79% = atenção · &lt; 60% = crítico. IPV ≥ 100% = supera a meta diária. IPV é o indicador mais direto de produtividade — não depende de simulador nem de capacidade teórica, só da meta declarada pela área.</div></div>
          <div class="gloss-item" style="background:#FFF8E7;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#D4900A;">⚠️ Importante Lembrar</div><div class="gloss-def">IPV não pondera ausência — quem visita muito mas falta muito ainda parece bem. Cruzar com IAP para a leitura líquida. Em janelas curtas (1m, parcial), IPV pode oscilar muito; preferir 3m ou MAT para decisão.</div></div>
        </div>
        ...
        <div class="gloss-card" style="border-top:3px solid #d97706;">
          ...
          <div class="gloss-item"><div class="gloss-term">📐 Fórmula</div><div class="gloss-def">|médicos visitados ∩ painel| ÷ |médicos visitados| × 100 (na janela).</div></div>
          <div class="gloss-item" style="background:#F0FAF8;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#00857C;">✅ Como Interpretar</div><div class="gloss-def">≥ 80% = excelente · 60–79% = bom · &lt; 60% = crítico. <strong>Diferente do ICA</strong>: ICA usa MCCP (subset prioritário); IFP usa o painel inteiro como referência. IFP baixo = consultor visitando médicos fora do painel alocado — pode ser oportunidade ou indisciplina.</div></div>
        ...
        <div class="gloss-card" style="border-top:3px solid #b91c1c;">
          <h3>IAP — Aproveitamento de Presença <span style="font-size:10px;font-weight:500;color:var(--purple);">◷ janela</span></h3>
          <div class="gloss-item"><div class="gloss-term">🔎 Pergunta de saúde da operação</div><div class="gloss-def"><em>"Considerando ausências e presença efetiva, o consultor entrega o esperado?"</em></div></div>
          <div class="gloss-item"><div class="gloss-term">📐 Fórmula</div><div class="gloss-def">Vis/dia × (1 − % ausência ÷ 100) ÷ meta vis/dia × 100. <strong>Versão líquida do IPV.</strong></div></div>
          <div class="gloss-item" style="background:#F0FAF8;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#00857C;">✅ Como Interpretar</div><div class="gloss-def">≥ 80% = saudável · 60–79% = atenção · &lt; 60% = crítico. <strong>IAP &lt; IPV sempre</strong> — a diferença mostra o quanto a ausência está corroendo a produtividade. IPV alto + IAP baixo = consultor produtivo mas com muita ausência (foco do gestor: presença).</div></div>
          <div class="gloss-item" style="background:#FFF8E7;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#D4900A;">⚠️ Importante Lembrar</div><div class="gloss-def">Ausências legítimas (treinamentos corporativos obrigatórios, congressos estratégicos) penalizam o IAP injustamente. Cruzar com a aba <strong>Ausências</strong> para entender a composição antes de cobrar.</div></div>
        </div>
        ...
        <div class="gloss-card" style="border-top:3px solid #B91C7A;">
          <h3>IDF — Disciplina de Frequência</h3>
          <div class="gloss-item"><div class="gloss-term">🔎 Pergunta de saúde da operação</div><div class="gloss-def"><em>"Dos médicos visitados, quantos receberam mais que uma visita no ano?"</em></div></div>
          <div class="gloss-item"><div class="gloss-term">📐 Fórmula</div><div class="gloss-def">(médicos visitados − médicos com 1x apenas) ÷ médicos visitados × 100.</div></div>
          <div class="gloss-item" style="background:#F0FAF8;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#00857C;">✅ Como Interpretar</div><div class="gloss-def">≥ 80% = saudável · 60–79% = atenção · &lt; 60% = crítico. <strong>Diferente do IRM</strong>: IRM mede média de visitas; IDF mede % de médicos recorrentes. Consultor pode ter IRM 6 (parece bom) mas IDF 30% (visita uns poucos muitas vezes — não distribui).</div></div>
          <div class="gloss-item" style="background:#FFF8E7;border-radius:4px;padding:8px 10px;"><div class="gloss-term" style="color:#D4900A;">⚠️ Importante Lembrar</div><div class="gloss-def">Em territórios novos, IDF baixo é esperado (consultor ainda mapeando). Não cobrar de quem tem &lt; 6 meses no setor.</div></div>
        </div>
    ...
    <!-- ── fim bloco 25 índices no glossário ── -->
...
function calcularCapacidadePerfil(perfil, p){
  ...
  //
  // Onda v3 — Máx. dias de ausência mensal (fórmula reversa):
  //   Pergunta: dado meu painel_ideal e meus parâmetros, quantos dias úteis
  //   posso me ausentar sem comprometer a meta de cobertura?
  //   visitas_necessarias = painel_ideal × freq × cobertura_alvo
  //   dias_campo_necessarios = visitas_necessarias / [visdia × (1 - noshow)]
  //   max_dias_ausencia = dias_uteis_mes - dias_campo_necessarios
  ...
  // Máx. dias de ausência (Onda v3) — fórmula reversa
  // Já descontamos o deslocamento; o que sobra é "margem para outras ausências"
  // (férias, treinamento, congresso, gestão, doença).
  const visitas_necessarias_mes = painel_ideal * freq * cobertura_frac;
  const cap_dia_util = p.visdia * (1 - noshow_frac);  // capacidade líquida por dia
  const dias_campo_necessarios = cap_dia_util > 0 ? visitas_necessarias_mes / cap_dia_util : dias_uteis_mes;
  // Por construção, dias_campo_necessarios ≈ dias_campo_mes (o painel_ideal foi calculado
  // justamente pra ocupar 100% dos dias de campo disponíveis). Então o "máx. ausências
  // além do deslocamento" tende a 0. Esse KPI faz sentido quando o usuário muda o painel
  // de referência (ex: usar painel_atual do consultor em vez do painel_ideal).
  const max_dias_ausencia_mes = Math.max(0, dias_uteis_mes - (p.desloc * semanas) - dias_campo_necessarios);
  ...
  return {
    ...
    // Onda v3 — máx. dias de ausência mensal (folga do simulador)
    max_dias_ausencia_mes: Math.round(max_dias_ausencia_mes*10)/10,
    // compatibilidade
...
// Fontes: IQVIA Field Force 2023, Sindusfarma, padrão SFE indústria, Brazil SFE
const BENCH = {
  ...
  isc:         {min:0.8, max:1.2, label:'ISC 0.8-1.2 (ideal)'},
  // Onda v3 — novos benchmarks
  max_aus:     {min:0, max:5, label:'Máx dias ausência 0-5/mês'},
  freq_real_local:  {min:0.9, max:1.1, label:'Freq real Local 0,9-1,1x'},
  freq_real_vint:   {min:0.8, max:1.0, label:'Freq real V.Interna 0,8-1,0x'},
  freq_real_vinter: {min:0.7, max:0.9, label:'Freq real V.Inter 0,7-0,9x'},
  visdia_real: {min:5, max:7, label:'Vis/dia real 5-7'},
  // 3 Índices Pharma SFE (Onda v3)
  ica: {min:60, max:100, label:'ICA — Cobertura Alvo (60-79% atenção, ≥80% saudável)'},
  icv: {min:0.60, max:1.0, label:'ICV — Consistência (0,60-0,79 atenção, ≥0,80 saudável)'},
  iet: {min:60, max:100, label:'IET — Eficiência Território (60-79 atenção, ≥80 saudável)'},
};
...
// ============================================================================
// ONDA v3 — AGREGADOS REAIS POR PERFIL (médias dos consultores no recorte)
// Usa dados que já existem no payload (c.freq_medico_mes, c.vis_dia_media) e
// agrega por tipo_setor para o card do simulador comparar esperado × real.
// ============================================================================
function calcMediasReaisPerfil(perfil_nome){
  const cs = getFilteredAtivos().filter(c => c.tipo_setor === perfil_nome);
  if(!cs.length) return {n:0, freq_real:null, visdia_real:null};
  // Freq real: média de freq_medico_mes entre consultores com dado válido
  const freqs = cs.map(c => c.freq_medico_mes).filter(v => v != null && v > 0);
  const visdias = cs.map(c => c.vis_dia_media).filter(v => v != null && v > 0);
  const avg = arr => arr.length ? arr.reduce((a,b)=>a+b,0) / arr.length : null;
  return {
    n: cs.length,
    n_freq: freqs.length,
    n_visdia: visdias.length,
    freq_real: avg(freqs),
    visdia_real: avg(visdias),
  };
}

// ============================================================================
// ONDA v3 — 3 ÍNDICES DE PERFORMANCE (BENCHMARK PHARMA SFE)
// ============================================================================
// ICA — Índice de Cobertura de Alvo ("The Right Doctors")
//   Definição original (proposta): % de Tier A visitados + % Tier B visitados / 2
//   ADAPTAÇÃO: payload não tem tiering A/B/C. Usamos o painel MCCP oficial
//   como proxy do "alvo institucional" — o que a área comercial já marcou
//   como prioritário fica em mdms_painel/mdms_dentro_mccp.
//   ICA = pct_dentro_mccp (% das visitas que caíram no painel MCCP do ciclo)
//   Substituível por uma versão com Tier real quando o dado estiver no payload.
function calcICA(c){
  if(!c.mccp_q_disponivel) return null;
  const pct = c.pct_dentro_mccp;
...
// ICV — Índice de Consistência de Visitação ("The Right Frequency")
//   Definição: 1 - (desvio padrão das visitas mensais / média das visitas mensais)
//   = 1 - coeficiente de variação. Quanto mais próximo de 1, mais constante o
//   fluxo de visitas (evita "pico de final de ciclo").
//   FONTE (Onda v3 final): visitas_mes_serie do payload — visitas absolutas/mês
//   nos últimos 3-6 meses, calculadas em processar_6m.py. Fiel à fórmula original.
//   Fallback: usa vd_6m_serie (vis/dia) quando visitas_mes_serie estiver vazia,
//   pra manter compatibilidade com payloads gerados antes da Onda v3.
function calcICV(c){
  let serie = c.visitas_mes_serie;
  // Fallback para payloads antigos
  if(!serie || !serie.length){
    serie = c.vd_6m_serie || [];
  }
  const vals = serie.filter(v => v != null && v > 0);
  if(vals.length < 3) return null;  // exige no mínimo 3 meses pra ter sentido
  const media = vals.reduce((a,b)=>a+b,0) / vals.length;
  if(media <= 0) return null;
  const variancia = vals.reduce((a,b)=>a + (b-media)**2, 0) / vals.length;
...
// IET — Índice de Eficiência de Território ("The Right Place")
//   Definição original (proposta): (Visitas Reais / Esperadas) × Concentração em sede
//   DECISÃO: já temos score_territorio (0-100) calculado em processar_6m.py
//   combinando overlap intra (35%) + overlap cross (10%) + viagem vs perfil (20%)
//   + % UF sede (15%) + delta painel atual×ideal (20%). Esse score cobre
//   exatamente o espírito do IET. Re-exposição direta evita duplicidade.
function calcIET(c){
  return c.score_territorio != null ? c.score_territorio : null;
}
function flagIET(v){
  if(v == null) return 'sem_dado';
  if(v >= 80) return 'saudavel';
  if(v >= 60) return 'atencao';
  return 'critico';
}
...
function renderSimPerfilCard(perfil, p){
  ...
  return `
    ...
    <div class="out-row" style="color:var(--ink2);font-size:11px;">
      <span>Máx. dias de ausência/mês <span style="font-size:9px;color:var(--ink3);">(férias, treino, gestão)</span>:</span>
      <strong style="color:${r.max_dias_ausencia_mes >= 2 ? 'var(--teal)' : r.max_dias_ausencia_mes > 0 ? 'var(--warn)' : 'var(--danger)'};">${r.max_dias_ausencia_mes}</strong>
    </div>
    <div class="sim-cobertura ok" style="background:#E8F4F2;color:var(--ink);">
      ...
      ${(() => {
        const m = calcMediasReaisPerfil(perfil_nome_real);
        if(!m.n) return '';
        const freqStr = m.freq_real != null ? m.freq_real.toFixed(2) + '×/mês' : '—';
        const vdStr   = m.visdia_real != null ? m.visdia_real.toFixed(1) : '—';
        // Gap entre esperado (simulador) e real (histórico)
        const gapFreq = m.freq_real != null ? (m.freq_real - p.freq).toFixed(2) : null;
        const gapVD   = m.visdia_real != null ? (m.visdia_real - p.visdia).toFixed(1) : null;
        const corGap = (g) => g == null ? 'var(--ink3)' : Math.abs(parseFloat(g)) < 0.2 ? 'var(--teal)' : parseFloat(g) < 0 ? 'var(--warn)' : 'var(--ink2)';
        return `
        <div style="margin-top:6px;padding:5px 8px;background:#FFFFFF66;border-radius:3px;font-size:10px;color:var(--ink2);line-height:1.5;">
          <div style="display:flex;justify-content:space-between;">
            <span>Freq. real média (${m.n_freq}/${m.n} consult.):</span>
            <strong style="color:${corGap(gapFreq)};">${freqStr}${gapFreq != null ? ` <span style="font-weight:500;">(${gapFreq > 0 ? '+' : ''}${gapFreq})</span>` : ''}</strong>
          </div>
          <div style="display:flex;justify-content:space-between;">
            <span>Vis/dia real média (${m.n_visdia}/${m.n} consult.):</span>
            <strong style="color:${corGap(gapVD)};">${vdStr}${gapVD != null ? ` <span style="font-weight:500;">(${gapVD > 0 ? '+' : ''}${gapVD})</span>` : ''}</strong>
          </div>
        </div>`;
      })()}
    </div>
...
function renderSim(){
  ...
  // 9) (Removido: Calculadora de viagem por UF)
}
...
function calcIPA(c){
  ...
  const anual = (c.medicos_unicos_mes||0)*12;
  return Math.min(100, Math.round(anual/c.painel_size*100));
}
...
function calcICO(c){
  ...
  const v = c[field];
  if(v == null){
    // Fallback: payload antigo sem campos por janela
    const ctx = _janCtx(c);
    if(!ctx.mdms_unicos_n) return null;
    const painelSet = new Set(c.mdms_painel || []);
    if(!painelSet.size) return null;
    const intersec = ctx.mdms_visitados.filter(m => painelSet.has(m)).length;
    const n = ctx.n_meses || 1;
    return Math.min(100, Math.round(intersec/n/c.painel_size*100));
  }
...
function calcITU(c){
  ...
  return Math.min(100, Math.round(ctx.visitas/cap_total*100));
}
...
function flagIAS(v){ return v==null?'sem_dado':v>=80?'excelente':v>=60?'bom':'critico'; }
...
// IRE — Risco de Erosão: composto usando IPO/IMP/ICO da janela ativa  [JANELA ◷]
function calcIRE(c){
  let s=0, n=0;
  const ipo = calcIPO(c);
...
function calcIUF(c){
  if(c.pct_visitas_uf_sede == null) return null;
  return Math.round(c.pct_visitas_uf_sede);
}
...
function calcIBT(c){
  if(c.pct_trabalhados == null) return null;
  return Math.round(c.pct_trabalhados);
}
...
function computeIndicesGD(cs){
  ...
  return Object.values(grupos).map(g=>({
    ...
    // 1. Cobertura
    ica:mFn(g.cs,calcICA), ipa:mFn(g.cs,calcIPA), ico:mFn(g.cs,calcICO),
...
function renderIndicesPharmaSFE(){
  ...
  if(perfilInfo){
    ...
    if(perfilFiltro === 'todos'){
      ...
      perfilInfo.textContent = `${total} consultores · Local ${nL} · Interna ${nVI} · Interestadual ${nVE}`;
    } else {
      perfilInfo.textContent = `${cs.length} de ${total} consultores filtrados`;
    }
  }
  if(!cs.length){
  ...
  const fmtICV = v => v==null?'—':v.toFixed(2);
  ...
  const thSec = (label, tip, secKey) => {
    ...
    return `<th class="num" style="background:${sec.bg};border-top:3px solid ${sec.border};">${label}<span class="tip" data-tip="${tip}"></span></th>`;
  };
  ...
  const m = {
    // 1. Cobertura
    ica:avgPct(calcICA), ipa:avgPct(calcIPA), ico:avgPct(calcICO), ipo:avgPct(calcIPO), ifp:avgPct(calcIFP),
    // 2. Capacidade
  ...
  // ── HEADER de bloco com cor lateral ─────────────────────────────────────
  const blockHeader = (label, secKey, sub) => `
    <div style="margin-bottom:6px;font-size:11px;color:var(--ink2);font-weight:700;letter-spacing:0.04em;text-transform:uppercase;display:flex;align-items:center;gap:8px;padding-left:8px;border-left:4px solid ${SEC[secKey].border};">
      <span>${label}</span>
      <span style="font-weight:400;text-transform:none;color:var(--ink3);">${sub}</span>
    </div>`;

  const kpiHtml = `
    ${blockHeader('1 · Cobertura &amp; Alcance', 'cobertura', '— Quanto do painel é tocado?')}
    <div class="kpi-grid" style="grid-template-columns:repeat(5,1fr);margin-bottom:14px;background:${SEC.cobertura.bg};padding:8px;border-radius:4px;">
      ${sumCard('ICA — Cob. Alvo', m.ica, flagICA, fmtPct, 'Visitas dentro do MCCP / total. Mede se o consultor visita os médicos priorizados pela estratégia.', false)}
      ${sumCard('IPA — Penetração', m.ipa, flagIPA, fmtPct, 'Médicos únicos visitados no ano / painel. Quantos do painel foram tocados ao menos uma vez?', false)}
      ${sumCard('ICO — Cob. Operacional', m.ico, flagICO, fmtPct, 'Médicos únicos visitados na janela / painel (média mensal). Quanto do painel cabe na rotina.', true)}
      ${sumCard('IPO — Painel Ocioso', m.ipo, flagIPO, fmtPct, '100 − ICO. % do painel não tocado na janela. Menor = melhor.', true)}
      ${sumCard('IFP — Foco no Painel', m.ifp, flagIFP, fmtPct, '% de médicos visitados que pertencem ao painel oficial. Disciplina vs dispersão.', true)}
    </div>

    ${blockHeader('2 · Capacidade &amp; Produtividade', 'capacidade', `— O time entrega o volume esperado? (janela ${janLbl})`)}
    <div class="kpi-grid" style="grid-template-columns:repeat(4,1fr);margin-bottom:14px;background:${SEC.capacidade.bg};padding:8px;border-radius:4px;">
      ${sumCard('ITU — Utilização', m.itu, flagITU, fmtPct, 'Visitas realizadas / capacidade teórica do perfil na janela. O consultor usa toda a sua capacidade?', true)}
      ${sumCard('IPV — Produtividade', m.ipv, flagIPV, fmtPct, 'Vis/dia da janela ÷ meta (6/dia) × 100. Produtividade pura.', true)}
      ${sumCard('IAP — Aproveitamento', m.iap, flagIAP, fmtPct, 'Vis/dia × (1 − ausência) ÷ meta × 100. Eficiência líquida considerando presença.', true)}
      ${sumCard('IDC — Densidade', m.idc, flagIDC, fmtNum, 'Médicos únicos ÷ dias trabalhados na janela. Amplitude diária do consultor.', true)}
    </div>

    ${blockHeader('3 · Cadência &amp; Consistência', 'cadencia', '— O ritmo é constante?')}
    <div class="kpi-grid" style="grid-template-columns:repeat(4,1fr);margin-bottom:14px;background:${SEC.cadencia.bg};padding:8px;border-radius:4px;">
      ${sumCard('ICV — Consistência', m.icv, flagICV, fmtICV, '1 − CV das visitas mensais. Próximo de 1 = ritmo constante; baixo = concentração em fim de ciclo.', false)}
      ${sumCard('IAS — Aderência MCCP', m.ias, flagIAS, fmtPct, '% cumprimento do plano MCCP no trimestre corrente. Meta: ≥80%.', false)}
      ${sumCard('IES — Estabilidade Intra-mês', m.ies, flagIES, fmtPct, '100 − CV de vis/dia. Regularidade dentro do mês (diferente do ICV que é entre-meses).', false)}
      ${sumCard('ITV — Tendência 6m', m.itv, flagITV, fmtPct, 'Slope dos últimos 6m de vis/dia em escala 0-100. Mede direção (subindo/caindo).', false)}
    </div>

    ${blockHeader('4 · Qualidade de Relacionamento', 'qualidade', '— Tratamento com profundidade suficiente?')}
    <div class="kpi-grid" style="grid-template-columns:repeat(4,1fr);margin-bottom:14px;background:${SEC.qualidade.bg};padding:8px;border-radius:4px;">
      ${sumCard('IRM — Repetição', m.irm, flagIRM, fmtNum, 'Visitas ÷ médicos únicos da janela. Profundidade do relacionamento (vezes/médico).', true)}
      ${sumCard('IMP — Manutenção', m.imp, flagIMP, fmtPct, '100 − turnover (últimos 3m). Mede estabilidade do painel.', false)}
      ${sumCard('IDF — Disciplina Freq.', m.idf, flagIDF, fmtPct, '% dos médicos visitados que receberam 2+ visitas no ano. Profundidade vs visita única.', false)}
      ${sumCard('IQP — Qualidade Plano', m.iqp, flagIQP, fmtPct, '% do painel com 4+ visitas/ano. Médicos atendidos com frequência adequada.', false)}
    </div>

    ${blockHeader('5 · Estrutura &amp; Risco de Território', 'estrutura', '— Estrutura territorial defensável?')}
    <div class="kpi-grid" style="grid-template-columns:repeat(5,1fr);margin-bottom:14px;background:${SEC.estrutura.bg};padding:8px;border-radius:4px;">
      ${sumCard('IET — Ef. Território', m.iet, flagIET, fmtPct, 'Score 0-100: overlap intra + cross + viagem×perfil + UF sede + delta painel.', false)}
      ${sumCard('IRE — Risco Erosão', m.ire, flagIRE, fmtPct, 'Score composto: IPO + turnover + ICO. Recalculado a cada janela.', true)}
      ${sumCard('IPT — Pressão Target', m.ipt, flagIPT, fmtPct, 'Painel real vs ideal teórico do perfil. 100=balanceado; <80=subutilizado ou pressionado.', false)}
      ${sumCard('IRO — Exclusividade Painel', m.iro, flagIRO, fmtPct, '% médicos exclusivos do consultor (não compartilhados). Alto = pouca sobreposição com outros consultores.', false)}
      ${sumCard('IUF — Fidelidade UF', m.iuf, flagIUF, fmtPct, '% visitas dentro da UF sede. CORTES CALIBRADOS POR PERFIL (Local≥90, Interna≥85, Interestadual≥60).', false)}
    </div>

    ${blockHeader('6 · Alocação de Tempo &amp; Ausências', 'tempo', '— Para onde vai o tempo do consultor?')}
    <div class="kpi-grid" style="grid-template-columns:repeat(3,1fr);margin-bottom:16px;background:${SEC.tempo.bg};padding:8px;border-radius:4px;">
      ${sumCard('IBT — Balanceamento Tempo', m.ibt, flagIBT, fmtPct, '% dias úteis efetivamente trabalhados (não ausentes).', false)}
      ${sumCard('IAA — Ausência Anômala', m.iaa, flagIAA, fmtPct, 'Ausência da janela vs padrão MAT do próprio consultor. 100=mantém padrão; <60=anomalia.', true)}
      ${sumCard('IAC — Concentração Ausência', m.iac, flagIAC, fmtPct, 'Diversidade da ausência (Shannon norm.). INFORMACIONAL: alto=distribuído entre categorias, baixo=concentrado em 1-2.', false)}
    </div>
  `;
  ...
  const thSecHead = `<tr style="background:#fff;">
    ...
    <th colspan="5" style="background:${SEC.cobertura.border};color:#fff;font-size:10.5px;text-align:center;padding:4px 6px;letter-spacing:0.04em;text-transform:uppercase;">1 · Cobertura</th>
    <th colspan="4" style="background:${SEC.capacidade.border};color:#fff;font-size:10.5px;text-align:center;padding:4px 6px;letter-spacing:0.04em;text-transform:uppercase;">2 · Capacidade</th>
    <th colspan="4" style="background:${SEC.cadencia.border};color:#fff;font-size:10.5px;text-align:center;padding:4px 6px;letter-spacing:0.04em;text-transform:uppercase;">3 · Cadência</th>
    <th colspan="4" style="background:${SEC.qualidade.border};color:#fff;font-size:10.5px;text-align:center;padding:4px 6px;letter-spacing:0.04em;text-transform:uppercase;">4 · Qualidade</th>
  ...
  const thRow = `<tr>
    ...
    ${thSec('ICA',   'Cob. Alvo — % visitas no MCCP',           'cobertura')}
    ${thSec('IPA',   'Penetração — % painel tocado/ano',         'cobertura')}
    ${thSec('ICO ◷', 'Cob. Operacional — % painel na janela',    'cobertura')}
    ${thSec('IPO ◷', 'Painel Ocioso (↓ melhor)',                 'cobertura')}
    ${thSec('IFP ◷', 'Foco no Painel — disciplina',              'cobertura')}
    ${thSec('ITU ◷', 'Utilização da capacidade',                 'capacidade')}
    ${thSec('IPV ◷', 'Produtividade — vis/dia vs meta',          'capacidade')}
    ${thSec('IAP ◷', 'Aproveitamento — prod × presença',         'capacidade')}
    ${thSec('IDC ◷', 'Densidade — médicos únicos/dia',           'capacidade')}
    ${thSec('ICV',   'Consistência mensal (0 a 1)',              'cadencia')}
    ${thSec('IAS',   'Aderência MCCP — % ciclo',                 'cadencia')}
    ...
    ${thSec('IDF',   'Disciplina freq — % 2x+',                  'qualidade')}
  ...
  if(grp === 'gd'){
    ...
    tabHtml = gds.map(g=>`<tr>
      ...
      ${cell(g.ipa, flagIPA(g.ipa), fmtPct, 'cobertura')}
      ...
      ${cell(g.ipv, flagIPV(g.ipv), fmtPct, 'capacidade')}
      ${cell(g.iap, flagIAP(g.iap), fmtPct, 'capacidade')}
      ${cell(g.idc, flagIDC(g.idc), fmtNum, 'capacidade')}
      ${cell(g.icv, flagICV(g.icv), fmtICV, 'cadencia')}
      ...
      ${cell(g.idf, flagIDF(g.idf), fmtPct, 'qualidade')}
    ...
    </tr>`).join('') || '<tr><td colspan="28" style="text-align:center;color:var(--ink3);padding:14px;">Sem dados.</td></tr>';
  } else {
    const linhas = cs.map(c=>({
      c,
      ica:calcICA(c), ipa:calcIPA(c), ico:calcICO(c), ipo:calcIPO(c), ifp:calcIFP(c),
    ...
    tabHtml = linhas.map(l=>`<tr>
      ...
      ${cell(l.ipa, flagIPA(l.ipa), fmtPct, 'cobertura')}
      ...
      ${cell(l.ipv, flagIPV(l.ipv), fmtPct, 'capacidade')}
      ${cell(l.iap, flagIAP(l.iap), fmtPct, 'capacidade')}
      ${cell(l.idc, flagIDC(l.idc), fmtNum, 'capacidade')}
      ${cell(l.icv, flagICV(l.icv), fmtICV, 'cadencia')}
      ...
      ${cell(l.idf, flagIDF(l.idf), fmtPct, 'qualidade')}
      ${cell(l.iqp, flagIQP(l.iqp), fmtPct, 'qualidade')}
      ${cell(l.iet, flagIET(l.iet), fmtPct, 'estrutura')}
      ${cell(l.ire, flagIRE(l.ire), fmtPct, 'estrutura')}
    ...
    </tr>`).join('') || '<tr><td colspan="28" style="text-align:center;color:var(--ink3);">Sem dados.</td></tr>';
  }

  cont.innerHTML = kpiHtml + `
    <div class="card-actions" style="justify-content:flex-end;margin-bottom:8px;">
      <button class="btn-exp" onclick="exportIndicesPharmaSFE()">↓ Exportar CSV (25 índices)</button>
    </div>
...
function exportIndicesPharmaSFE(){
  ...
  const rows = cs.map(c => {
    // 25 índices em 6 subgrupos
    const ica=calcICA(c), ipa=calcIPA(c), ico=calcICO(c), ipo=calcIPO(c), ifp=calcIFP(c);
    const itu=calcITU(c), ipv=calcIPV(c), iap=calcIAP(c), idc=calcIDC(c);
    const icv=calcICV(c), ias=calcIAS(c), ies=calcIES(c), itv=calcITV(c);
    const irm=calcIRM(c), imp=calcIMP(c), idf=calcIDF(c), iqp=calcIQP(c);
    ...
    return [
      ...
      // valores
      f1(ica), f1(ipa), f1(ico), f1(ipo), f1(ifp),
      f1(itu), f1(ipv), f1(iap), f2(idc),
      f3(icv), f1(ias), f1(ies), f1(itv),
      f2(irm), f1(imp), f1(idf), f1(iqp),
      f1(iet), f1(ire), f1(ipt), f1(iro), f1(iuf),
      f1(ibt), f1(iaa), f1(iac),
      // flags
      flagICA(ica), flagIPA(ipa), flagICO(ico), flagIPO(ipo), flagIFP(ifp),
      flagITU(itu), flagIPV(ipv), flagIAP(iap), flagIDC(idc),
      flagICV(icv), flagIAS(ias), flagIES(ies), flagITV(itv),
      flagIRM(irm), flagIMP(imp), flagIDF(idf), flagIQP(iqp),
      flagIET(iet), flagIRE(ire), flagIPT(ipt), flagIRO(iro), flagIUF(iuf, c),
      flagIBT(ibt), flagIAA(iaa), flagIAC(iac),
    ];
  });
  downloadCsv('indices_performance_25.csv',
    ['Consultor','SF','GD','Perfil','Janela',
     // valores
     'ICA(%)','IPA(%)','ICO(%)','IPO(%)','IFP(%)',
     'ITU(%)','IPV(%)','IAP(%)','IDC(med/dia)',
     'ICV','IAS(%)','IES(%)','ITV(%)',
     'IRM(vis/med)','IMP(%)','IDF(%)','IQP(%)',
     'IET(%)','IRE(%)','IPT(%)','IRO(%)','IUF(%)',
     'IBT(%)','IAA(%)','IAC(%)',
     // flags
     'Flag ICA','Flag IPA','Flag ICO','Flag IPO','Flag IFP',
     'Flag ITU','Flag IPV','Flag IAP','Flag IDC',
     'Flag ICV','Flag IAS','Flag IES','Flag ITV',
     'Flag IRM','Flag IMP','Flag IDF','Flag IQP',
...
function renderHistograms(){
  ...
  // ── Onda v5: histograma "painel" agora responde à janela ──────────────────
  // Em MAT → painel_size (snapshot oficial — métrica estrutural)
  // Em 3m/1m/parcial → médicos únicos visitados na janela (varia por período)
  // Justificativa: painel é snapshot único no payload (não há histórico mensal),
  // então mostrar mdms_visitados_<jan> é a única forma honesta de fazer responder.
  const usaPainelSnapshot = (jan === 'mat');
  const tituloCardPainel = usaPainelSnapshot
    ? 'Tamanho de painel — distribuição'
    : `Médicos atendidos — distribuição (${janLabel})`;
  ...
  if(tituloEl) tituloEl.textContent = tituloCardPainel;

  const painelField = usaPainelSnapshot ? 'painel_size'
                    : jan==='3m' ? 'mdms_visitados_3m'
                    : jan==='1m' ? 'mdms_visitados_1m'
                    : 'mdms_visitados_parcial';
  const getPainelVal = (p) => {
    if(usaPainelSnapshot) return p.painel_size;
    const arr = p[painelField] || [];
    return arr.length;
  };
  const binSizePainel = usaPainelSnapshot ? 10 : (jan==='3m' ? 10 : 5);
  ...
  if(isSingleConsultor && csFilt.length===1){
    ...
    valsVis = peers.map(p=>p[visField]||0).filter(v=>v>0);
    mePainel = getPainelVal(c);
    meVis = c[visField]||0;
    const labelMetricaPainel = usaPainelSnapshot ? 'painel' : `médicos atendidos (${janLabel})`;
    subPainel = `${peers.length} consultor${peers.length===1?'':'es'} da SF ${sf} (Brasil) · linha laranja = ${c.nome.split(' ')[0]} · linha tracejada = média da SF · métrica = ${labelMetricaPainel}`;
    subVis = `${janLabel} · ${peers.length} consultor${peers.length===1?'':'es'} da SF ${sf}`;
  } else {
    valsPainel = csFilt.map(c=>getPainelVal(c)).filter(v=>v>0);
    valsVis = csFilt.map(c=>c[visField]||0).filter(v=>v>0);
    mePainel = null;
    meVis = null;
    const labelMetricaPainel = usaPainelSnapshot
      ? 'tamanho de painel (snapshot)'
      : `médicos únicos atendidos na janela (${janLabel})`;
    subPainel = valsPainel.length + ` consultores · ${labelMetricaPainel} · linha tracejada = média`;
  ...
  document.getElementById('svg-hist-painel').innerHTML =
    histBars(valsPainel, 460, 240, mePainel, '#6B3FA0', v=>v.toFixed(0), binSizePainel, isSingleConsultor? 'Você' : null);
...
function bindSortDOM(tableId){
  ...
  if(state.col < 0){
    const DEFAULT_SORT_COL = {
      ...
      'tbl-painel-ideal':          3,
      'tbl-alvo-perfil':            2,
      'tbl-indices-pharma':         6,  // Onda v3 — sort por IET asc (críticos no topo)
    };
